...
# Tick sources
# ---------------------------------------------------------------------------
# v3.46: run_sim/run_historical/run_alpaca moved to feeds.py. They only
# ever used .symbols/.configure_symbols()/.send_trade()/.pump(), so one
# duck-typed copy now drives BOTH this Bridge (--port, real hardware)
# and the direct TickEngine (the default). Re-exported here so every
# existing importer keeps working unchanged.
from feeds import run_sim, run_historical, run_alpaca   # noqa: E402,F401
